...
if __name__ == "__main__":
    iterList = []
    with open ("./iterated_files.txt","r") as iteratedtxt:
        for iterated in iteratedtxt:
            iterList += iterated,
    ...
    for file_name in os.listdir(directory):
        ...
        if file_opened == 0: 
            ...
            f.close()
            with open("./iterated_files.txt","a") as update_read:
                update_read.write(file_name+"\n")
            update_read.close()
